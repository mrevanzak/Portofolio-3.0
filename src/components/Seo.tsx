...
const defaultMeta = {
  ...
  siteName: 'ReV',
  description:
    'Revanza Kurniawan - Software Engineer and Undergraduate Student at Institut Teknologi Sepuluh Nopember',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://www.mrevanzak.dev',
  type: 'website',
  robots: 'follow, index',
  /**
